...
const NOTE_TRANSLATION_CACHE_KEY = "ihg_note_translation_cache_v4";
...
const CAT = {
  ...
  subcategory: { 火車站: { en: "Train Station", ja: "鉄道駅" }, 捷運站: { en: "MRT Station", ja: "MRT駅" }, 寺廟: { en: "Temple", ja: "寺院" }, 公園: { en: "Park", ja: "公園" }, 其他: { en: "Other", ja: "その他" }, 古蹟: { en: "Historic Site", ja: "史跡" }, 商圈: { en: "Commercial Area", ja: "商業エリア" }, 飯店: { en: "Hotel", ja: "ホテル" }, 銀行: { en: "Bank", ja: "銀行" }, 郵局: { en: "Post Office", ja: "郵便局" }, 停車場: { en: "Parking", ja: "駐車場" }, 早餐: { en: "Breakfast", ja: "朝食" }, 午餐: { en: "Lunch", ja: "晝食" }, 晚餐: { en: "Dinner", ja: "夕食" }, 宵夜: { en: "Late Night", ja: "夜食" }, 咖啡: { en: "Coffee", ja: "コーヒー" }, 素食: { en: "Vegetarian", ja: "ベジタリアン" }, 穆斯林: { en: "Muslim-friendly", ja: "ムスリム対応" }, 超市: { en: "Supermarket", ja: "スーパー" }, 藥妝: { en: "Drugstore", ja: "ドラッグストア" }, 走路10分內: { en: "Within 10-min walk", ja: "徒歩10分以內" } },
...
function normalizeApiPlaceItem(item, index) {
  ...
  return {
    ...
    name_ja: normalizeText(item?.name_ja),
